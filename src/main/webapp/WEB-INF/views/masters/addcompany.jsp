...
<title>Ujwal Billing Soft</title>
							...
							<form action="${pageContext.request.contextPath}/insertCompany"
								...
								<div class="row">
									...
									<div class="col-md-4">
											...
											pattern="^[A-Za-z\s]+$" value="${editComp.compName}" maxlength="50"
									...
									<textarea id="comp_add" name="comp_add" class="form-control"
											...
											maxlength="200"
											onchange="try{setCustomValidity('')}catch(e){}" required>${editComp.address}</textarea>
									</div>
								</div>
						...
						<div class="card-body card-block">
							<form action="${pageContext.request.contextPath}/insertCompany"
								...
								<div class="row">
									...
									<div class="col-md-2">Logo*</div>
									<div class="col-md-4">
										<input type="text" id="logo" name="logo" maxlength="10"
											style="width: 100%;" class="form-control"
											value="${editComp.logo}" autocomplete="off"
											oninvalid="setCustomValidity('Please enter tel no')"
											onchange="try{setCustomValidity('')}catch(e){}"
											pattern="^[A-Za-z\s]+$"	style="width: 50%;" autocomplete="off" class="form-control"
											required> <span class="error"
											aria-live="polite"></span>
								...
								<div class="row">
									...
									<div class="col-md-4">
										...
										<input type="text" id="gst_no" name="gst_no" required
											...
											autocomplete="off"
											oninvalid="setCustomValidity('Please enter GST no')"
											maxlength="20" value="${editComp.gstin}"
											pattern="^([0]{1}[1-9]{1}|[1-2]{1}[0-9]{1}|[3]{1}[0-7]{1})([a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}[1-9a-zA-Z]{1}[zZ]{1}[0-9a-zA-Z]{1})+$"
											onkeydown="upperCaseF(this)"
											onchange="try{setCustomValidity('')}catch(e){}" /> <span
											class="error" aria-live="polite"></span>
									...
									<tbody>
										<c:forEach items="${compList}" var="comp" varStatus="count">
											<tr>
												...
												<td style="text-align: center">${comp.gstin}</td>
